...
func Handler(useCase *create_link.CreateLinkUseCase) func(ctx context.Context, msg messaging.Message) error {
	return func(ctx context.Context, msg messaging.Message) error {
		...
		if err != nil {
			log.Error().Err(err).Msg("Failed to decode create payment payload")
			return err
		}
